...
public class CallDeepseekHD implements HttpHandler {
    ...
    public void handle(HttpExchange exchange) throws IOException {
        ...
        if ("POST".equals(method)) {
            ...
            json += "  {\"role\": \"system\", \"content\": \"You are a helpful assistant.answer in chinese.\"},";
            json += "  {\"role\": \"user\", \"content\": \"" + requestBody + "\"}";
            json += "]" + "}";
